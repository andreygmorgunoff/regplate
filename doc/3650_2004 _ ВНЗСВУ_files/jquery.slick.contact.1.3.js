	...
	$.fn.dcSlickContactStick = function(options) {
		...
		return $dcSlickObj.each(function(options){
			...
			function slickOpen(){
				...
				var paramInit = {marginBottom: "-5px"};
				var paramOpen = {marginBottom: 0};
				if(defaults.location == 'top'){
					paramInit = {marginTop: "-5px"};
					paramOpen = {marginTop: 0};
				}
				if(defaults.location == 'left'){
					paramInit = {marginLeft: "-5px"};
					paramOpen = {marginLeft: 0};
				}
				if(defaults.location == 'right'){
					paramInit = {marginRight: "-5px"};
					paramOpen = {marginRight: 0};
				}
				$slider.css({zIndex: 10001}).addClass('active').animate(paramInit, "fast").animate(paramOpen, defaults.speed);
			}
